...
export const metadata: Metadata = {
  ...
  description:
    'English melody pages with letter notes, optional numbered notes, fingering charts, and switchable ocarina, recorder, and tin whistle setups on supported songs.',
  robots: {
    index: true,
    follow: true
  },
