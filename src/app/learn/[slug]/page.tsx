      ...
      <section className="page-warm-container">
        ...
        <section className={`page-warm-panel p-6 md:p-7 ${isHubGuide ? 'mt-5' : 'mt-8'}`}>
          ...
          <p className="mt-3 max-w-none text-sm leading-7 text-stone-700">
            Choose a song below to open a playable practice page with letter notes and fingering
            chart support. Start with the shortest familiar melodies first, then move into longer
            songs when the first phrases feel stable.
          </p>
          <div className="mt-6">
            <LearnSongCardGrid
