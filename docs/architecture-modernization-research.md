...
| D | 进行中 | Layout / measure_layout、fingering_index、instrument 已改成 runtime display command；仍需继续观察 note_label_mode / show_note_range / practice_tool 这些脚本能力相关状态 | 完成后记录哪些设置仍会 remount |
